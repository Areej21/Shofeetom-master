...
<head>
    ...
    <meta name="description"
        content="Shofeetom CPanel admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin template, Shofeetom CPanel admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title style="font-family: 'Noto Kufi Arabic', sans-serif !important;">@yield('page-title')</title>
    <link rel="apple-touch-icon" href="{{ asset('cpanel-style/app-assets/images/ico/apple-icon-120.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('cpanel-style/app-assets/images/ico/favicon.ico') }}">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600"
        rel="stylesheet">

    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/vendors/css/vendors-rtl.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/vendors/css/charts/apexcharts.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/vendors/css/extensions/toastr.min.css') }}">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/bootstrap.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/bootstrap-extended.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/colors.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/components.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/themes/dark-layout.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/themes/bordered-layout.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/themes/semi-dark-layout.css') }}">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/core/menu/menu-types/horizontal-menu.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/pages/dashboard-ecommerce.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/plugins/charts/chart-apex.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('cpanel-style/app-assets/css-rtl/plugins/extensions/ext-component-toastr.css') }}">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/app-assets/css-rtl/custom-rtl.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('cpanel-style/assets/css/style-rtl.css') }}">
    <!-- END: Custom CSS-->
    <!-- Toastr -->
    {{-- <link rel="stylesheet" href="{{ asset('cpanel-style/app-assets/vendors/css/extensions/toastr.min.css') }}"> --}}
...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover"
        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand"
                        href="cpanel-style/html/rtl/horizontal-menu-template/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text mb-0">Shofeetom CPanel</h2>
                    </a></li>
            </ul>
        </div>
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon"
                    ...
                    <div class="search-input">
                        ...
                        <input class="form-control input" type="text" placeholder="Explore Shofeetom CPanel..."
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('cpanel-style/app-assets/images/pages/eCommerce/1.png') }}"
                                    alt="donuts" width="62">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('cpanel-style/app-assets/images/pages/eCommerce/7.png') }}"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('cpanel-style/app-assets/images/pages/eCommerce/2.png') }}"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('cpanel-style/app-assets/images/pages/eCommerce/3.png') }}"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="{{ asset('cpanel-style/app-assets/images/pages/eCommerce/5.png') }}"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-15.jpg') }}"
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-3.jpg') }}"
                                                alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">John Doe</span><span
                                ...
                                src="{{ asset('cpanel-style/app-assets//images/portrait/small/avatar-s-11.jpg') }}"
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                ...
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('cpanel-style/app-assets/images/icons/xls.png') }}"
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('cpanel-style/app-assets/images/icons/jpg.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('cpanel-style/app-assets/images/icons/pdf.pn') }}g"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
                href="app-file-manager.html">
                <div class="d-flex">
                    <div class="me-75"><img src="{{ asset('cpanel-style/app-assets/images/icons/doc.png') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-8.jpg') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-1.jpg') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-14.jpg') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
                ...
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img
                            src="{{ asset('cpanel-style/app-assets/images/portrait/small/avatar-s-6.jpg') }}"
                            alt="png" height="32"></div>
                    <div class="search-data">
    ...
    <div class="horizontal-menu-wrapper">
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                <!-- include cpanel-style/includes/mixins-->
    ...
    <!-- BEGIN: Vendor JS-->
    <script src="{{ asset('cpanel-style/app-assets/vendors/js/vendors.min.js') }}"></script>
    <!-- BEGIN Vendor JS-->

    <!-- BEGIN: Page Vendor JS-->
    <script src="{{ asset('cpanel-style/app-assets/vendors/js/ui/jquery.sticky.js') }}"></script>
    <script src="{{ asset('cpanel-style/app-assets/vendors/js/charts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('cpanel-style/app-assets/vendors/js/extensions/toastr.min.js') }}"></script>
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="{{ asset('cpanel-style/app-assets/js/core/app-menu.js') }}"></script>
    <script src="{{ asset('cpanel-style/app-assets/js/core/app.js') }}"></script>
    <!-- END: Theme JS-->

    <!-- BEGIN: Page JS-->
    <script src="{{ asset('cpanel-style/app-assets/js/scripts/pages/dashboard-ecommerce.js') }}"></script>
    <!-- END: Page JS-->
