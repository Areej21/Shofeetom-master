        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">إنشاء صلاحية جديدة</h4>
                </div>
                @if ($errors->any())
                    <div class="card-body">
                ...
                @endif
                <div class="card-body">
                    <form class="form form-horizontal" action="{{ route('permissions.store') }}" method="POSt">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                            ...
                            <div class="col-sm-9 offset-sm-3">
                                <button type="submit"
                                    class="btn btn-primary me-1 waves-effect waves-float waves-light">إنشاء</button>
