...
@section('page-title', 'Permissions Index')
        ...
        <div class="card-body">
            <div class="demo-spacing-0">
                <div class="alert alert-danger" role="alert">
                    <h4 class="alert-heading">أخطاء إنشاء صلاحية جديدة</h4>
        ...
        <div class="card-datatable table-responsive pt-0">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="d-flex justify-content-between align-items-center header-actions mx-1 row mt-75">
                    ...
                    @livewire('permissions.permission-search')
                </div>
            </div>
...
@section('scripts')
    <script>
        function confirmDestroy(id, refrance) {
            Swal.fire({
                title: 'هل أنت متأكد ؟',
                text: "لا يمكنك التراجع عن هذا التعديل !",
                icon: 'warning',
        ...
        function destoy(id, refrance) {
            // shofeetom/cpanel/permissions/{permission}
            axios.delete('/shofeetom/cpanel/permissions/' + id)
